## subway_algorithm.R
## usage: Rscript subway_algorithm Mattapan Airport ; if the station name is two words, please use quotes: Rscript subway_algorithm.R "Government Center" "Harvard"
